...
1. **The best engineering is the code you never wrote.** Every line is one
   more place a bug can live and one more thing to maintain. Code is a
...
5. **A few strong tools beat many new ones.** Stay modern, but don't chase
   every release. Pick a small, proven set and build around it.
